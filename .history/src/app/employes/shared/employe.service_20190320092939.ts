...
export class EmployeService {
  ...
  constructor(privapublicpte: HttpClient) { }
  ...
  putEmploye(formData: Employe) {
    return this.http.put(this.rootURL + '/employe/' + formData.id, formData);

   }

   deleteEmploye(id: number) {
    console.log(this.http.delete(this.rootURL + '/employe/' + id));
    return this.http.delete(this.rootURL + '/employe/' + id);
   }
}
